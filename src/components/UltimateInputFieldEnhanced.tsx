  ...
  const addMenuItem = () => {
    if (newMenuItemLabel.trim()) {
      const newItem: MenuItem = {
        ...
        action: () => console.log(`Custom action: ${newMenuItemLabel.trim()}`),
        type: 'custom'
      };
    ...
    >
      ...
      {!isDocked && resizable && (
        <div className="corner-tabs">
          ...
          <div
            className="corner-tab br expander"
            onPointerDown={(e) => handleCornerResizePointerDown(e, 'br')}
            title="Resize bottom-right"
          >
            <div className="expander-arrow br-arrow">↘</div>
          </div>
          {/* Bottom-left expander */}
          <div
            className="corner-tab bl expander"
            onPointerDown={(e) => handleCornerResizePointerDown(e, 'bl')}
            title="Resize bottom-left"
          >
            <div className="expander-arrow bl-arrow">↙</div>
          </div>
          {/* Top-right expander */}
          <div
            className="corner-tab tr expander"
            onPointerDown={(e) => handleCornerResizePointerDown(e, 'tr')}
            title="Resize top-right"
          >
            <div className="expander-arrow tr-arrow">↗</div>
          </div>
          {/* Top-left corner - no expander, just resize handle */}
          <div
            className="corner-tab tl resize-handle"
              ...
              <div className="add-menu-item">
                <input
                  ...
                  onKeyDown={(e) => {
                    ...
                    if (e.key === 'Escape') setIsAddingMenuItem(false);
                  }}
                  autoFocus
                />
                <div className="add-menu-controls">
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={addMenuItem}
                    disabled={!newMenuItemLabel.trim()}
                    type="button"
                  >
                    Add
                  </Button>
